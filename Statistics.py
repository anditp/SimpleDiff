...
#%%
v = np.load("/Users/andrei/Desktop/bl/velocities_normalized.npy", mmap_mode = "r")[:30000,0,:]
v1 = np.expand_dims(v, axis = 1)
v1.shape
#%%
w0 = np.load("/Users/andrei/Desktop/bl/generated_samples_224538_1d.npy", mmap_mode = "r").transpose((0, 2, 1))
w0.shape

#%%
plt.plot(w0[0].flatten())
plt.show()
#%%
class Statistics:
...
vals_T = T.delta_tau_V(1)
vals_S = S.delta_tau_V(1)
