...
def train_distributed(replica_id, replica_count, port, model_params):
    ...
    dataset = dataset_from_file(model_params["data_path"], model_params["batch_size"], model_params["levels"], is_distributed=True, num_workers=4, coordinate=model_params.coordinate)
